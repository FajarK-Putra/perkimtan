...
export const metadata: Metadata = {
  title: 'Pengajuan Sengketa | Dinas Perkimtan Sumbar',
  description: 'Tata cara pengajuan sengketa informasi publik ke Komisi Informasi - PPID Dinas Perumahan, Kawasan Permukiman dan Pertanahan Provinsi Sumatera Barat',
}
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white pt-24 pb-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Pengajuan Sengketa Informasi</h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Tata cara pengajuan penyelesaian sengketa informasi publik ke Komisi Informasi Provinsi Sumatera Barat
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-semibold text-gray-900">Alur Penyelesaian Sengketa</h2>
            </div>
