...
export default function RusunawaPage() {
  const rusunData = {
    name: 'Program Rumah Susun Sederhana (Rusunawa)',
    description: 'Program pembangunan rumah susun sederhana untuk masyarakat berpenghasilan rendah',
    benefits: [
      'Hunian terjangkau bagi MBR',
      'Lokasi strategis dekat fasilitas umum',
      'Standar bangunan yang memenuhi syarat teknis',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(16,185,129,0.1)_1px,transparent_0)] [background-size:20px_20px] pointer-events-none"></div>
      
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl mb-6 shadow-lg">
            <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
            </svg>
          </div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-600 bg-clip-text text-transparent mb-4">
            Rumah Susun Sederhana (Rusunawa)
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            {rusunData.description}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-white/50">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">
                  Keuntungan Program Rusunawa
                </h3>
              </div>
              <div className="grid sm:grid-cols-2 gap-4">
                {rusunData.benefits.map((benefit: string, index: number) => (
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-white/50">
              ...
              <div className="space-y-3">
                {rusunData.requirements.map((req: string, index: number) => (
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-white/50">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">
                  Lokasi Rusunawa di Sumatera Barat
                </h3>
              </div>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-gray-900">Kota Padang</h4>
                  </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="font-bold text-gray-900">Kota Bukittinggi</h4>
                  </div>
                  <ul className="text-gray-700 space-y-2">
                    <li className="flex items-center">
          ...
          <div className="space-y-8">
            {/* Features Card */}
            <div className="bg-gradient-to-br from-teal-500 via-emerald-500 to-green-500 rounded-2xl p-8 text-white shadow-lg">
              <div className="flex items-center mb-6">
              ...
              <div className="space-y-4">
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                  <div className="flex items-center mb-2">
                    ...
                    <h4 className="font-bold">Desain Modern</h4>
                  </div>
                  <p className="text-sm opacity-90">Bangunan dengan desain yang modern dan fungsional</p>
                </div>
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                  <div className="flex items-center mb-2">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h4 className="font-bold">Keamanan 24 Jam</h4>
                  </div>
                  <p className="text-sm opacity-90">Sistem keamanan dan petugas jaga 24 jam</p>
                </div>
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                  <div className="flex items-center mb-2">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm opacity-90">Dekat dengan pusat kota dan fasilitas umum</p>
                </div>
                <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                  <div className="flex items-center mb-2">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm opacity-90">Dilengkapi area parkir, taman, dan ruang bersama</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-white/50">
              ...
              <p className="text-gray-600 mb-6">
                Untuk informasi lebih lanjut mengenai Program Rusunawa, silakan hubungi:
              </p>
              <div className="space-y-4">
