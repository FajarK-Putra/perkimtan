...
export const metadata: Metadata = {
  title: 'Galeri Foto | Dinas Perkimtan Sumbar',
  description: 'Galeri foto kegiatan dan dokumentasi Dinas Perumahan, Kawasan Permukiman dan Pertanahan Sumatera Barat',
}
        ...
        <AnimatedSection>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              Halaman Galeri Foto sedang dalam pengembangan
            </h2>
